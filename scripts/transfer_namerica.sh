...
DATEm2=$(sed -n "287p" main17.php | cut -c 41-50)
DATEm3=$(sed -n "287p" main17.php | cut -c 54-63)
DATEm4=$(sed -n "287p" main17.php | cut -c 67-76)
DATEm5=$(sed -n "287p" main17.php | cut -c 80-89)
echo $DATE
echo $DATEm1
echo $DATEm2
echo $DATEm3
