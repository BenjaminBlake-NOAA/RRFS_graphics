...
for var in ${vars}; do
  convert Control_no_${var}_${dom}_f${fhr}.gif Control_yes_${var}_${dom}_f${fhrp6}.gif +append mem1-2_${var}_${dom}_f${fhr}.gif
  convert 1_no_${var}_${dom}_f${fhr}.gif 1_yes_${var}_${dom}_f${fhrp6}.gif +append mem3-4_${var}_${dom}_f${fhr}.gif
  convert mem1-2_${var}_${dom}_f${fhr}.gif mem3-4_${var}_${dom}_f${fhr}.gif +append mem1-4_${var}_${dom}_f${fhr}.gif

  convert 2_no_${var}_${dom}_f${fhr}.gif 2_yes_${var}_${dom}_f${fhrp6}.gif +append mem5-6_${var}_${dom}_f${fhr}.gif
  convert 3_no_${var}_${dom}_f${fhr}.gif 3_yes_${var}_${dom}_f${fhrp6}.gif +append mem7-8_${var}_${dom}_f${fhr}.gif
  convert mem5-6_${var}_${dom}_f${fhr}.gif mem7-8_${var}_${dom}_f${fhr}.gif +append mem5-8_${var}_${dom}_f${fhr}.gif

  convert 4_no_${var}_${dom}_f${fhr}.gif 4_yes_${var}_${dom}_f${fhrp6}.gif +append mem9-10_${var}_${dom}_f${fhr}.gif
  convert 5_no_${var}_${dom}_f${fhr}.gif 5_yes_${var}_${dom}_f${fhrp6}.gif +append mem11-12_${var}_${dom}_f${fhr}.gif
...
# Make sure row of images with colorbars is the same width as the other 2 rows
  ...
  convert HRRR_no_${var}_${dom}_f${fhr}.gif HRRR_yes_${var}_${dom}_f${fhrp6}.gif +append mem13-14_${var}_${dom}_f${fhr}.gif
# Place final image in parent directory
  convert mem1-12_${var}_${dom}_f${fhr}.gif mem13-14_${var}_${dom}_f${fhr}.gif -append ../${var}_members_${dom}_f${fhr}.gif
