...
DATE=$(sed -n "287p" main18.php | cut -c 15-24)
DATEm1=$(sed -n "287p" main18.php | cut -c 28-37)
DATEm2=$(sed -n "287p" main18.php | cut -c 41-50)
DATEm3=$(sed -n "287p" main18.php | cut -c 54-63)
DATEm4=$(sed -n "287p" main18.php | cut -c 67-76)
DATEm5=$(sed -n "287p" main18.php | cut -c 80-89)
echo $DATE
echo $DATEm1
echo $DATEm2
echo $DATEm3
...
sed '287s/var cyclist=\["'${DATE}'","'${DATEm1}'","'${DATEm2}'","'${DATEm3}'","'${DATEm4}'","'${DATEm5}'"\]/var cyclist=\["'${CDATE}'","'${DATE}'","'${DATEm1}'","'${DATEm2}'","'${DATEm3}'","'${DATEm4}'"\]/' main18.php > tmpfile ; mv tmpfile main18.php
