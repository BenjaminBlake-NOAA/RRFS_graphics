...
domains = ['conus','alaska','puerto_rico','hawaii']
...
def metplus_process(domain):
  ...
  if dom in ['alaska','hawaii','puerto_rico']:
      # Process MRMS files
      metplus_utils.prep_mrms_precip(
          ymd, hour, DCOMmrms, MRMS_DIR, PARM_DIR, dom
      )
  else:
      # Process CCPA files
      metplus_utils.prep_ccpa_precip(
          ymd, hour, COMccpa, CCPA_DIR, PARM_DIR
      )
