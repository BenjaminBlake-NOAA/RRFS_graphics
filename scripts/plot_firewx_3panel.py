...
data1 = grib2io.open('/lfs/h1/ops/prod/com/nam/v4.2/nam.'+ymd+'/nam.t'+cyc+'z.firewxnest.hiresf'+fhour+'.tm00.grib2')
data2 = grib2io.open('/lfs/h2/emc/ptmp/emc.lam/para/com/rrfsfw/v1.0.0/rrfsfw.'+ymd+'/'+cyc+'/rrfsfw.t'+cyc+'z.hires.f0'+fhour+'.grib2')

if (fhr >= 1):
  data1_m1 = grib2io.open('/lfs/h1/ops/prod/com/nam/v4.2/nam.'+ymd+'/nam.t'+cyc+'z.firewxnest.hiresf'+fhour1+'.tm00.grib2')
  data2_m1 = grib2io.open('/lfs/h2/emc/ptmp/emc.lam/para/com/rrfsfw/v1.0.0/rrfsfw.'+ymd+'/'+cyc+'/rrfsfw.t'+cyc+'z.hires.f0'+fhour1+'.grib2')
  data1_f00 = grib2io.open('/lfs/h1/ops/prod/com/nam/v4.2/nam.'+ymd+'/nam.t'+cyc+'z.firewxnest.hiresf00.tm00.grib2')
  data2_f00 = grib2io.open('/lfs/h2/emc/ptmp/emc.lam/para/com/rrfsfw/v1.0.0/rrfsfw.'+ymd+'/'+cyc+'/rrfsfw.t'+cyc+'z.hires.f000.grib2')
...
#  plt.clabel(cs2_b,np.arange(60,90,3),inline_spacing=1,fmt='%d',fontsize=5)
  ...
  compress_and_save('compare925_'+dom+'_f'+fhour+'.png')
  t2 = time.perf_counter()
  t3 = round(t2-t1, 3)
...
#################################
  if (fhr > 0):
    ...
    compress_and_save('compareqpf1_'+dom+'_f'+fhour+'.png')
    t2 = time.perf_counter()
    t3 = round(t2-t1, 3)
...
#################################
  ...
  compress_and_save('compareweasd_'+dom+'_f'+fhour+'.png')
  t2 = time.perf_counter()
  t3 = round(t2-t1, 3)
...
#################################
  if (fhr > 0):
    ...
    compress_and_save('compareweasd1_'+dom+'_f'+fhour+'.png')
    t2 = time.perf_counter()
    t3 = round(t2-t1, 3)
...
#################################
  ...
  compress_and_save('comparehgtpbl_'+dom+'_f'+fhour+'.png')
  t2 = time.perf_counter()
  t3 = round(t2-t1, 3)
  print(('%.3f seconds to plot PBL height for: '+dom) % t3)
...
#################################
  ...
  # Wind barb density settings
    ...
    compress_and_save('compareminrh_'+dom+'_f'+fhour+'.png')
    t2 = time.perf_counter()
    t3 = round(t2-t1, 3)
...
#################################
  ...
  compress_and_save('comparevrate_'+dom+'_f'+fhour+'.png')
  t2 = time.perf_counter()
  t3 = round(t2-t1, 3)
